    ...
    inner class ViewHolder(private val view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(pokemon: Pokemon) {
            ...
            val imageId = when(pokemon.type) {
                Pokemon.PokemonType.GRASS -> R.drawable.icon_grass
                Pokemon.PokemonType.FIRE -> R.drawable.icon_fire
                Pokemon.PokemonType.WATER -> R.drawable.icon_water
                Pokemon.PokemonType.FIGHTER -> R.drawable.icon_fighter
                Pokemon.PokemonType.ELECTRIC -> R.drawable.icon_electric
            }
