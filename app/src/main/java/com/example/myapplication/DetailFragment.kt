    ...
    fun setPokemonData(pokemon: Pokemon) {
        ...
        Glide.with(this).load(pokemon.imageURL).listener(object: RequestListener<Drawable>{
            override fun onLoadFailed(
                ...
                imageView.setImageResource(com.google.android.material.R.drawable.ic_mtrl_chip_close_circle)
                return false
            }
        ...
        }).error(com.google.android.material.R.drawable.ic_mtrl_chip_close_circle).into(imageView)
